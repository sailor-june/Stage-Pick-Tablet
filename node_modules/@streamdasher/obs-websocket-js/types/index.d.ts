...
declare module "@streamdasher/obs-websocket-js" {
  ...
  interface RequestMethodsArgsMap {
    ...
    ExecuteBatch: { requests: string[]; abortOnFail?: boolean };
    ...
    ReorderSceneItems: { scene?: string; items: string[] };
  ...
  interface RequestMethodReturnMap {
    ...
    ExecuteBatch: { messageId: string; status: "ok"; results: string[] };
    ...
    GetSourceTypesList: {
      messageId: string;
      status: "ok";
      types: { doNotSelfMonitor: boolean }[];
    };
    ...
    ListProfiles: { messageId: string; status: "ok"; profiles: string[] };
  ...
  interface EventHandlersDataMap {
    ...
    TransitionListChanged: { transitions: string[] };
    ...
    SourceFiltersReordered: { sourceName: string; filters: boolean[] };
